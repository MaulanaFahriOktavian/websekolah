...
export default function StaffForm({ staff = null, isEdit = false }) {
    ...
    function removeSelectedPhoto() {
        setData('photo', null);
        setPhotoPreview(staff?.photo ? `/storage/${staff.photo}` : null);
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
            {/* 1. Identity & Position */}
            <FormSection
                title="Identitas & Tugas Kependidikan"
                description="Informasi nama staf tata usaha, laboratorium, perpustakaan, atau pendukung operasional."
            >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <InputField
                        ...
                        error={errors.name}
                        placeholder="contoh: H. Suherman, S.AP."
                    />
                    ...
                    <InputField
                        ...
                        error={errors.nip}
                        placeholder="18 digit NIP (kosongkan jika tidak ada)"
                        hint="Opsional"
                    />

                    <InputField
                        id="position"
                        label="Jabatan / Bidang Tugas"
                        value={data.position}
                    ...
                    <InputField
                        ...
                        hint="Angka lebih kecil tampil lebih awal (contoh: 1 untuk Kepala Tata Usaha)"
                    />
                </div>
                ...
                <InputField
                    id="bio"
                    as="textarea"
                    label="Keterangan / Uraian Tugas (Opsional)"
                    value={data.bio}
                    onChange={(e) => setData('bio', e.target.value)}
                    error={errors.bio}
                    placeholder="Uraian ringkas tugas atau peran pelayanan..."
                    rows={3}
                />
            </FormSection>
            ...
            <FormSection
                ...
                description="Staf nonaktif tidak akan ditampilkan pada direktori website publik."
            >
                <label className="inline-flex items-center gap-2.5 cursor-pointer">
                    ...
                    <span className="text-sm text-slate-700 font-medium">
                        Status Staf Aktif (Ditampilkan di Website)
                    </span>
                </label>
            </FormSection>
            ...
            <div className="flex items-center justify-between pt-2">
                ...
                >
                    ...
                    <span>{processing ? 'Menyimpan...' : isEdit ? 'Perbarui Data Staf' : 'Simpan Data Staf'}</span>
                </button>
            </div>
        </form>
    );

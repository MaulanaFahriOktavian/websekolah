...
export default function Index({ facilities, filters }) {
    ...
    return (
        <PublicLayout title="Fasilitas & Sarana Prasarana">
            {/* Hero Banner */}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="max-w-2xl space-y-4">
                        ...
                        <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                            Lingkungan belajar modern dengan fasilitas lengkap dan terawat untuk mendukung potensi akademik serta non-akademik siswa.
                        </p>
                    </div>
                </div>
            </section>

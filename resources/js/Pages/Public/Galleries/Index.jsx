...
export default function Index({ galleries, filters }) {
    ...
    return (
        <PublicLayout
            ...
            description="Dokumentasi foto kegiatan, prestasi, acara, dan momen berharga sekolah."
            ogType="website"
        >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-2xl space-y-3">
                        ...
                        <p className="text-slate-300 text-sm sm:text-base leading-relaxed">
                            Momen berharga dan dokumentasi visual berbagai aktivitas, upacara, perlombaan, serta dinamika belajar siswa sekolah.
                        </p>
                    </div>
                </div>
            </section>
